...
- All the fields mentioned in the schema are always present in span attributes also. If present in both, use the dedicated columns instead of span attributes.
